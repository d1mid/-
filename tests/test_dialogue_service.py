...
# Проверяет, что dialogues.txt успешно загружается.
...
# Проверяет поиск близкой реплики по опечатке.
...
# Проверяет тематический fallback для автомобильной темы.
...
# Проверяет тематический fallback для темы погоды.
